...
urlpatterns = [
    ...
    path('purchases/<int:purchase_pk>/plan/add/', views.pledge_plan_add,
         name='pledge_plan_add'),
    path('purchases/<int:purchase_pk>/plan/', views.pledge_plan_detail,
         name='pledge_plan_detail'),
    path('purchases/<int:purchase_pk>/plan/edit/', views.pledge_plan_edit,
         name='pledge_plan_edit'),
    path('purchases/<int:purchase_pk>/plan/items/add/', views.pledge_plan_item_add,
    ...
    path('purchases/<int:purchase_pk>/plan/bundles/add/', views.pledge_plan_bundle_add,
